...
namespace MPLSMS
{
    public partial class frmPaymentReciept : Form
    {
        public frmPaymentReciept()
        {
            InitializeComponent();
        }
        ...
        private void frmPaymentReciept_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            rptPaymentSlip objRpt = new rptPaymentSlip();
            objRpt.SetDataSource(ds_ID.Tables[0]);
            crvPaymentReceipt.ReportSource = objRpt;
            crvPaymentReceipt.Refresh();
        ...
        private void rptPaymentSlip1_InitReport(object sender, EventArgs e)
        {
